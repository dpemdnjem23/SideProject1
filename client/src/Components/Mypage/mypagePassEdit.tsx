...
const MypagePassEdit = () => {
  ...
  return (
    <div id="Mypage_passEdit">
      <div className="Mypage_passEdit_section">
        <div className="Mypage_passEdit_title">비밀번호 수정</div>
        <div className="Mypage_passEdit_gap"></div>
        <div className="Mypage_passEdit_pass passsection sts">
          <div className="Mypage_passEdit_description">비밀번호</div>
          <div className="Mypage_passEdit_pass passsubsection">
            <input
              onBlur={passwordBlur}
              onChange={handleUserPass}
              type="password"
              className="Mypage_passEdit_contents"
            ></input>
          </div>
        </div>
        <span className="Mypage_passEdit_err">{passErrMessage}</span>

        <div className="Mypgae_passdit_gap2"></div>
        <div className="Mypage_passEdit_passcheck passsection">
          <div className="Mypage_passEdit_description">비밀번호 확인</div>

          <div className="Mypage_passEdit_passcheck_sub passsubsection">
            <input
        ...
        <span className="Mypage_passEdit_err">{passCheckErrMessage}</span>

        <div className="Mypage_passEdit_btsection">
          <button onClick={handlePsssModifyBt} className="Mypage_passEdit_bt">
            변경하기
          </button>
        </div>
      </div>
